...
================================================== -->
  ...
  <script type="text/javascript" charset="UTF-8" src="https://maps.googleapis.com/maps-api-v3/api/js/55/6/common.js"></script>
  <script type="text/javascript" charset="UTF-8" src="https://maps.googleapis.com/maps-api-v3/api/js/55/6/util.js"></script>
      ...
      <nav class="navbar navbar-expand-sm navbar-light py-0">
        ...
        <div class="collapse navbar-collapse" id="navigation">
          <ul class="navbar-nav ml-auto text-center">
            ...
            <!-- <li class="nav-item dropdown active">
              <a class="nav-link dropdown-toggle" href="#!" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                Statistik <i class="tf-ion-chevron-down"></i>
              </a>
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                <li><a class="dropdown-item" href="index.html">Data realisasi investasi</a></li>
                <li><a class="dropdown-item" href="onepage-slider.html">Pemetaan Investasi</a></li>
      ...
      <div class="container">
        <div class="row justify-content-around">
          <div class="col-lg-4 col-md-6 mb-5 mb-lg-0">
            <img loading="lazy" class="logo-default" src="{{ asset('assets/website/images/logo.png') }}" alt="logo1">

            <p><br> Dinas Penanaman Modal Pelayanan Terpadu Satu pintu<br>
              TENAGA KERJA DAN TRANSMIGRASI
              KABUPATEN KONAWE KEPULAUAN</p>
          </div>
          <!-- End of .col-sm-3 -->
          ...
          <div class="col-lg-2 col-md-6 mb-5 mb-lg-0">
            <ul>
              ...
              <li><a href="service.html">Jenis Perizinan</a></li>
              <li><a href="service.html">Standar Pelayanan (SP)</a></li>
              <li><a href="service.html">Tahapan Perizinan</a></li>
            </ul>
          </div>
          <!-- End of .col-sm-3 -->
          ...
          <div class="col-lg-3 col-md-6 mb-5 mb-md-0">
            <ul>
              ...
              <li><a href="about.html">Alamat: Kompleks perkantoran jalan poros langara - Lampeapi KM 3</a></li>
              <li><a href="service.html">Kode Pos: 93391</a></li>
              <li><a href="blog.html">Email: dpmptsp@konkepkab.go.id</a></li>
              <li><a href="404.html">Phone: (0401) 3129641</a></li>
            </ul>
          </div>
          <!-- End of .col-sm-3 -->
